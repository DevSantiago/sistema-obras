...
import { obtenerAdjuntoMovimientoFondoService } from "@/modules/fondos/fondos.service";
...
function construirContentDisposition(nombreArchivo: string) {
  const nombre = path.basename(nombreArchivo).trim() || "soporte-movimiento";
...
export async function GET(_request: Request, context: RouteContext) {
  try {
    ...
    console.error("Error consultando soporte de movimiento:", error);
